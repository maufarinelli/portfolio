    ...
    <body>
        ...
        <section id="about-us">
        	<div class="row">
                ...
                <p><?php echo $aLang['about.copy7']; ?></p>
            </div>
        </section>
            ...
            <div class="web-projects-wrapper clearfix">
                ...
                <div class="project">
                    <div class="project-window">
                        ...
                        <img class="logo hide-logo evolio" src="images/logos/evolio.png">
                    </div>
                ...
                <div class="project">
                    <div class="project-window">
                        ...
                        <img class="window-left" src="images/window_left.png" width="85" height="196">
                        <img class="window-right" src="images/window_right.png" width="80" height="196">
                        <img class="logo hide-logo palmhavas" src="images/logos/palmhavas.png">
                    </div>
            ...
            <div class="web-projects-wrapper clearfix">
                ...
                <div class="project">
                    ...
                    <img class="logo hide-logo senna" src="images/logos/senna.jpg">
                        ...
                        <a class="cta" href="web_projects/senna/" target="_blank"><?php echo $aLang['projects.website.cta']; ?></a>
                </div>
                ...
                <div class="project">
                    ...
                    <img class="logo hide-logo blackjack" src="images/logos/blackjack.jpg">
                        ...
                        <a class="cta" href="web_projects/blackjack/21blackjack.html" target="_blank"><?php echo $aLang['projects.blackjack.cta']; ?></a>
                </div>
                ...
                <div class="project">
                    ...
                    <img class="logo hide-logo guitar" src="images/logos/guitar.jpg">
                        ...
                        <a class="cta" href="web_projects/guitar/guitar_illustration.html" target="_blank"><?php echo $aLang['projects.guitar.cta']; ?></a>
                </div>
